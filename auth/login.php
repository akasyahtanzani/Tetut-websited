                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <dotlottie-player src="https://lottie.host/0153c193-5619-46d2-8be5-45c40c62b1d4/zugvbTg2sD.json" background="transparent" speed="1" style="width: 400px; height: 500px;" loop autoplay></dotlottie-player>
                            </div>

                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">hello welcome to Tutet !</h1>
                                        <h3 class="h6 text-gray-900">Tutet Hadir untuk menampung semua keluhanmu,kecuali keluhan hidup😊✌️</h3>
                                    </div>
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <button type="submit" name="login" class="btn btn-primary btn-user btn-block">Login in here yahh</button>
                                    </form>
