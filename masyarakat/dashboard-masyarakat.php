...
// ambil data lporan dengan feedback 
$reportrs_with_feedback = get_report_with_feedback_by_user($_SESSION['username'],$conn);
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"  style="background: #6a5fa1;">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Tutet</div>
            </a>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tunggu sebentar Laporan Dalam Proses</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <?php foreach($reportrs_with_feedback as $p): ?>
                                        <div class="card p-4 mb-3">
                                            <strong>Tanggal Laporan : </strong>
                                            ...
                                            <p><?= $p['feedback'] ?? "belum ada feedvack"?></p>
