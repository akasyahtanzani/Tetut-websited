                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Silahkan masukan data-data yang dimintai!</h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="lable-control" for="username">Deskripsi laporan kamu</label>
                                        ...
                                        <button type="submit" name="submit" class="btn btn-primary">Submit di sini</button>
                                    </form>
                                </div>
